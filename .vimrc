...
func SetTitle()
    if &filetype == 'python'
        ...
        call append(line(".")+8, "")
        call append(line(".")+9, "")
        call append(line(".")+10, "\#                         _oo8oo_")
        call append(line(".")+11, "\#                        o8888888o")
        call append(line(".")+12, "\#                        88\" . \"88")
        call append(line(".")+13, "\#                        (| -_- |)")
        call append(line(".")+14, "\#                        0\\  =  /0")
        call append(line(".")+15, "\#                      ___/'==='\\___")
        call append(line(".")+16, "\#                    .' \\\\|     |// '.")
        call append(line(".")+17, "\#                   / \\\\|||  :  |||// \\")
        call append(line(".")+18, "\#                  / _||||| -:- |||||_ \\")
        call append(line(".")+19, "\#                 |   | \\\\\  -  /// |   |")
        call append(line(".")+20, "\#                 | \\_|  ''\\---/''  |_/ |")
        call append(line(".")+21, "\#                 \\  .-\\__  '-'  __/-.  /")
        call append(line(".")+22, "\#               ___'. .'  /--.--\  '. .'___")
        call append(line(".")+23, "\#            .\"\" '<  '.___\\_<|>_/___.'  >' \"\".")
        call append(line(".")+24, "\#           | | :  `- \\`.:`\\ _ /`:.`/ -`  : | |")
        call append(line(".")+25, "\#           \\  \\ `-.   \\_ __\\ /__ _/   .-` /  /")
        call append(line(".")+26, "\#       =====`-.____`.___ \\_____/ ___.`____.-`=====")
        call append(line(".")+27, "\#                         `=---=`")
        call append(line(".")+28, "\#")
        call append(line(".")+29, "\#                佛祖保佑        永无BUG")
        call append(line(".")+30, "")
        call append(line(".")+31, "")
        call append(line(".")+32, "def main():")
        call append(line(".")+33, "    print('All works have done.')")
        call append(line(".")+34, "")
        call append(line(".")+35, "if __name__ == \"__main__\":")
        call append(line(".")+36, "    main()")
        call append(line(".")+37, "")
    endif
    if &filetype == 'sh'
